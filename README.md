...
Then access it from Safari running in OSX like this: http://<my mac ip address>:3000/, use admin/admin for first access changing the password after that to the usual one.
